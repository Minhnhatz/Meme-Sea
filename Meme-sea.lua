...
local Window = redzlib:MakeWindow({ Title = "Crystal Hub : Meme Sea", SubTitle = "by ghost", SaveFolder = "redzHub-MemeSea.json" })
Window:AddMinimizeButton({
  Button = { Image = "rbxassetid://18922213322", BackgroundTransparency = 0 },
...
local _Discord = Tabs.Discord do
  _Discord:AddDiscordInvite({
    Name = "Crystal Hub | 75%",
    Description = "Join our discord for get new notifications update log",
    Logo = "rbxassetid://18922213322",
    Invite = "https://discord.com/invite/EayEasHrRE"
  })
end
